...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D653BC816A1452")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class G_CP_Download : OpenSpan.Automation.Automator
{
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D653BC816A1452\\EntryPoint-8D653BC831B6D2A")]
	...
	public G_CP_Download()
	{
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(G_CP_Download));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452");
		// 
		// Set component Ids
		// 
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D653BC831B6D2A"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D653BCDE24A5E8"));
		this.SetId(this.exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D653BCF0418706"));
		this.SetId(this.exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D653BCF3B502DA"));
		this.SetId(this.labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8D653BD120F951D"));
		this.SetId(this.labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8D653BD15E5CCD2"));
		this.SetId(this.labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8D653BD186560F8"));
		this.SetId(this.tryHost2, new OpenSpan.Design.ComponentIdentity("TryHost-8D65459D8BD7D4B"));
		this.SetId(this.catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8D65459DA8B915D"));
		this.SetId(this.connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D65459EF5E8D96"));
		this.SetId(this.jumpHost5, new OpenSpan.Design.ComponentIdentity("JumpHost-8D65459F5C00038"));
		this.SetId(this.jumpHost6, new OpenSpan.Design.ComponentIdentity("JumpHost-8D65459FA55A8F2"));
		this.SetId(this.connectableProperties4, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D6545A1F71B8CF"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D6545B7B8E1EA6"));
		// 
		// G_CP_Download
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_G_CP_Download_1_");
		this.DocumentScale = 0.798358F;
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_G_CP_Download_2_");
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_G_CP_Download_3_");
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_G_CP_Download_4_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\EntryPoint-8D653BC831B6D2A");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_G_CP_Download_5_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_G_CP_Download_6_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\EntryPoint-8D653BC831B6D2A");
		// 
		// exitPoint2
		// 
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_G_CP_Download_5_");
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_G_CP_Download_6_");
		...
		this.exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\EntryPoint-8D653BC831B6D2A");
		// 
		// exitPoint3
		// 
		...
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_G_CP_Download_5_");
		...
		dynamicpropertyinfo8.CodeDomData = _resources_.GetString("_G_CP_Download_6_");
		...
		this.exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\EntryPoint-8D653BC831B6D2A");
		// 
		// labelHost1
		// 
		...
		dynamicmethodinfo2.CodeDomData = _resources_.GetString("_G_CP_Download_7_");
		...
		dynamicmethodinfo3.CodeDomData = _resources_.GetString("_G_CP_Download_8_");
		...
		dynamicpropertyinfo9.CodeDomData = _resources_.GetString("_G_CP_Download_9_");
		...
		dynamicmethodinfo4.CodeDomData = _resources_.GetString("_G_CP_Download_8_");
		...
		dynamicpropertyinfo10.CodeDomData = _resources_.GetString("_G_CP_Download_9_");
		...
		this.tryHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\TryHost-8D65459D8BD7D4B");
		// 
		// catchHost2
		// 
		...
		dynamiceventinfo1.CodeDomData = _resources_.GetString("_G_CP_Download_10_");
		...
		dynamicpropertyinfo11.CodeDomData = _resources_.GetString("_G_CP_Download_11_");
		...
		this.catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\CatchHost-8D65459DA8B915D");
		// 
		// connectableMethod13
		// 
		this.connectableMethod13.DisplayName = "<URL_Download>";
		this.connectableMethod13.ExceptionsHandled = false;
		this.connectableMethod13.InstanceTypeName = "OpenSpan.Script.Custom.Script";
		this.connectableMethod13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D6544C87132412\\Script-8D654591CD4B967");
		...
		this.jumpHost5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\LabelHost-8D653BD120F951D");
		...
		this.jumpHost5.MemberPrototypes.Add(memberprototype2);
		...
		this.jumpHost6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\LabelHost-8D653BD186560F8");
		...
		this.jumpHost6.MemberPrototypes.Add(memberprototype3);
		...
		this.connectableProperties4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D653BECF19FCC7\\StringVariable-8D653C0941E8D78");
		...
		this.connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D653BECF19FCC7\\StringVariable-8D6545B0F85A316");
		...
		// 
		this.CodeDomData = _resources_.GetString("_G_CP_Download_12_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D653BC831B6D2A"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D653BCDE24A5E8"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_G_CP_Download_5_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_G_CP_Download_6_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_G_CP_Download_3_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo4 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo4.IsSerializable = true;
		dynamicpropertyinfo4.NoInputConvesion = false;
		dynamicpropertyinfo4.Source = "";
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_G_CP_Download_4_");
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\EntryPoint-8D653BC831B6D2A");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D653BC831B6D2A"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D653BCF0418706"));
		...
		exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\EntryPoint-8D653BC831B6D2A");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D653BC831B6D2A"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D653BCF3B502DA"));
		...
		exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\EntryPoint-8D653BC831B6D2A");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D653BC831B6D2A"));
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8D653BD120F951D"));
		labelHost1.DisplayName = "Success";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_G_CP_Download_7_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8D653BD15E5CCD2"));
		labelHost2.DisplayName = "Failure";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_G_CP_Download_8_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_G_CP_Download_9_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8D653BD186560F8"));
	...
	internal OpenSpan.Automation.Design.TryHost Create_tryHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(tryHost2, new OpenSpan.Design.ComponentIdentity("TryHost-8D65459D8BD7D4B"));
		tryHost2.DisplayName = "TRY";
		tryHost2.ExceptionsHandled = false;
		tryHost2.InstanceTypeName = "OpenSpan.Automation.Design.TryHost";
		tryHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\TryHost-8D65459D8BD7D4B");
		// 
		// Result
		// 
		return tryHost2;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8D65459DA8B915D"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_G_CP_Download_11_");
		...
		catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\CatchHost-8D65459DA8B915D");
		// 
		// Result
		// 
		return catchHost2;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod13(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D65459EF5E8D96"));
		connectableMethod13.DisplayName = "<URL_Download>";
		connectableMethod13.ExceptionsHandled = false;
		connectableMethod13.InstanceTypeName = "OpenSpan.Script.Custom.Script";
		connectableMethod13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D6544C87132412\\Script-8D654591CD4B967");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "URL_Download";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost5(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost5, new OpenSpan.Design.ComponentIdentity("JumpHost-8D65459F5C00038"));
		jumpHost5.DisplayName = "<GoToLabel>";
		jumpHost5.ExceptionsHandled = false;
		jumpHost5.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\LabelHost-8D653BD120F951D");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost6(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost6, new OpenSpan.Design.ComponentIdentity("JumpHost-8D65459FA55A8F2"));
		jumpHost6.DisplayName = "<GoToLabel>";
		jumpHost6.ExceptionsHandled = false;
		jumpHost6.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D653BC816A1452\\LabelHost-8D653BD186560F8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties4, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D6545A1F71B8CF"));
		...
		connectableProperties4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D653BECF19FCC7\\StringVariable-8D653C0941E8D78");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D6545B7B8E1EA6"));
		connectableProperties1.DefaultValues = "";
		connectableProperties1.DisplayName = "Properties";
		connectableProperties1.ExceptionsHandled = false;
		connectableProperties1.InstanceTypeName = "OpenSpan.Controls.StringVariable";
		connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D653BECF19FCC7\\StringVariable-8D6545B0F85A316");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
