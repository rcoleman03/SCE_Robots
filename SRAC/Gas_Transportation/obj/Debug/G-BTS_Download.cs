...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D6544F7974DB16")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class G_BTS_Download : OpenSpan.Automation.Automator
{
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D6544F7974DB16\\EntryPoint-8D6544F8A993FAB")]
	...
	public G_BTS_Download()
	{
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(G_BTS_Download));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16");
		// 
		// Set component Ids
		// 
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D6544F8A993FAB"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D6544FB69F39E4"));
		this.SetId(this.exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D6544FB9D74444"));
		this.SetId(this.exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D6544FBF18219F"));
		this.SetId(this.labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8D6544FC83ED919"));
		this.SetId(this.labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8D6544FCBEB046A"));
		this.SetId(this.labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8D6544FCE1801F2"));
		this.SetId(this.jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8D65450C80B97DE"));
		this.SetId(this.jumpHost3, new OpenSpan.Design.ComponentIdentity("JumpHost-8D65450CF3AD3BA"));
		this.SetId(this.connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D6545BFAD92D90"));
		this.SetId(this.tryHost2, new OpenSpan.Design.ComponentIdentity("TryHost-8D6545BFADC3AD6"));
		this.SetId(this.catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8D6545BFADF481C"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D6545C1DCEC202"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D6545C234C4D17"));
		// 
		// G_BTS_Download
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_G_BTS_Download_1_");
		this.DocumentScale = 0.8145062F;
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_G_BTS_Download_2_");
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_G_BTS_Download_3_");
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_G_BTS_Download_4_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\EntryPoint-8D6544F8A993FAB");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_G_BTS_Download_5_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_G_BTS_Download_6_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\EntryPoint-8D6544F8A993FAB");
		// 
		// exitPoint2
		// 
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_G_BTS_Download_5_");
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_G_BTS_Download_6_");
		...
		this.exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\EntryPoint-8D6544F8A993FAB");
		// 
		// exitPoint3
		// 
		...
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_G_BTS_Download_5_");
		...
		dynamicpropertyinfo8.CodeDomData = _resources_.GetString("_G_BTS_Download_6_");
		...
		this.exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\EntryPoint-8D6544F8A993FAB");
		// 
		// labelHost1
		// 
		...
		dynamicmethodinfo2.CodeDomData = _resources_.GetString("_G_BTS_Download_7_");
		...
		dynamicmethodinfo3.CodeDomData = _resources_.GetString("_G_BTS_Download_8_");
		...
		dynamicpropertyinfo9.CodeDomData = _resources_.GetString("_G_BTS_Download_9_");
		...
		dynamicmethodinfo4.CodeDomData = _resources_.GetString("_G_BTS_Download_8_");
		...
		dynamicpropertyinfo10.CodeDomData = _resources_.GetString("_G_BTS_Download_9_");
		...
		this.jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\LabelHost-8D6544FC83ED919");
		...
		this.jumpHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\LabelHost-8D6544FCE1801F2");
		...
		this.jumpHost3.MemberPrototypes.Add(memberprototype2);
		...
		memberprototype3.MemberName = "URL_Download";
		memberprototype3.MemberType = System.Reflection.MemberTypes.Method;
		parameterprototype2.CanRead = false;
		parameterprototype2.CanWrite = true;
		parameterprototype2.DefaultSet = false;
		parameterprototype2.DefaultValue = "url";
		...
		parameterprototype3.DefaultValue = "localPath";
		parameterprototype3.ParamName = "localPath";
		...
		this.connectableMethod13.MemberPrototypes.Add(memberprototype3);
		...
		this.tryHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\TryHost-8D6545BFADC3AD6");
		// 
		// catchHost2
		// 
		...
		dynamiceventinfo1.CodeDomData = _resources_.GetString("_G_BTS_Download_10_");
		...
		dynamicpropertyinfo11.CodeDomData = _resources_.GetString("_G_BTS_Download_11_");
		...
		this.catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\CatchHost-8D6545BFADF481C");
		// 
		...
		this.connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D653BECF19FCC7\\StringVariable-8D6545B0E1EE1A3");
		...
		// 
		this.CodeDomData = _resources_.GetString("_G_BTS_Download_12_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D6544F8A993FAB"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D6544FB69F39E4"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_G_BTS_Download_5_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_G_BTS_Download_6_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_G_BTS_Download_3_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo4 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo4.IsSerializable = true;
		dynamicpropertyinfo4.NoInputConvesion = false;
		dynamicpropertyinfo4.Source = "";
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_G_BTS_Download_4_");
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\EntryPoint-8D6544F8A993FAB");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D6544F8A993FAB"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D6544FB9D74444"));
		...
		exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\EntryPoint-8D6544F8A993FAB");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D6544F8A993FAB"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D6544FBF18219F"));
		...
		exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\EntryPoint-8D6544F8A993FAB");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D6544F8A993FAB"));
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8D6544FC83ED919"));
		labelHost1.DisplayName = "Success";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_G_BTS_Download_7_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8D6544FCBEB046A"));
		labelHost2.DisplayName = "Failure";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_G_BTS_Download_8_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_G_BTS_Download_9_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8D6544FCE1801F2"));
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8D65450C80B97DE"));
		jumpHost2.DisplayName = "<GoToLabel>";
		jumpHost2.ExceptionsHandled = false;
		jumpHost2.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\LabelHost-8D6544FC83ED919");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost3, new OpenSpan.Design.ComponentIdentity("JumpHost-8D65450CF3AD3BA"));
		jumpHost3.DisplayName = "<GoToLabel>";
		jumpHost3.ExceptionsHandled = false;
		jumpHost3.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\LabelHost-8D6544FCE1801F2");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod13(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D6545BFAD92D90"));
	...
	internal OpenSpan.Automation.Design.TryHost Create_tryHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(tryHost2, new OpenSpan.Design.ComponentIdentity("TryHost-8D6545BFADC3AD6"));
		tryHost2.DisplayName = "TRY";
		tryHost2.ExceptionsHandled = false;
		tryHost2.InstanceTypeName = "OpenSpan.Automation.Design.TryHost";
		tryHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\TryHost-8D6545BFADC3AD6");
		// 
		// Result
		// 
		return tryHost2;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8D6545BFADF481C"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_G_BTS_Download_11_");
		...
		catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D6544F7974DB16\\CatchHost-8D6545BFADF481C");
		// 
		// Result
		// 
		return catchHost2;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D6545C1DCEC202"));
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D6545C234C4D17"));
		...
		connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D653BECF19FCC7\\StringVariable-8D6545B0E1EE1A3");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
